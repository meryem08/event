...
// function InfoCard() {
//   const [eventManagerData, setEventManagerData] = useState(null);
//   const $token = `2|rDHDbbKjugkVwG9GlTodT3ibNx2fRkyhYTg7VFmf6cea8512`
...
function InfoCard() {
  const [eventManagerData, setEventManagerData] = useState(null);
  const token = '2|rDHDbbKjugkVwG9GlTodT3ibNx2fRkyhYTg7VFmf6cea8512'; // Replace with your actual access token
  ...
  useEffect(() => {
    ...
    fetchEventManagerData();
  }, [token]); // Added dependency to re-run the effect when the token changes
